...
:       blank_frame
        ...
        loop 6
                ...
                frame 1, 2
                move BACK, 19
                attacker_action 6 + $30
                frame 2, 2
                move FORWARD, 30
                attacker_action 16
                blank_frame 2
                end_loop
        attacker_action 7 + $30
:       blank_frame
        move_vec_char :-, -12, 16
...
; d0/0d35
        ...
        loop 9
                ...
                cycle_pal BG1_ANIM, 2, {1, 6}
                frame 0
                target_action 24, 7 + $30
                cycle_pal BG1_ANIM, 2, {1, 6}
                frame 0
                cycle_pal BG1_ANIM, 2, {1, 6}
                frame 0
                target_action 7 + $30 , 24
                cycle_pal BG1_ANIM, 2, {1, 6}
                frame 0
                cycle_pal BG1_ANIM, 2, {1, 6}
                frame 0
...
_d06ced:
        ...
        vec_offset 16
        move BACK, 16
        attacker_action 7, 23
        frame 0, 2
        frame 1, 2
        attacker_action 24, 7 + $30
        frame 2, 2
        frame 3, 2
        attacker_action 7 + $30, 24
        frame 4, 2
        frame 5, 2
        attacker_action 23, 7
        frame 6, 2
        unpause_layer BG1
        attacker_action 4, 6
        sfx
...
_d07cbd:
        ...
        call _d07130
        loop 2
                attacker_action 23, 24
                blank_frame 2
                attacker_action 7 + $30, 7
                blank_frame 2
                attacker_action 24, 23
                blank_frame 2
                attacker_action 7, 7 + $30
                blank_frame 2
                end_loop
        sfx
        move FORWARD, 17
