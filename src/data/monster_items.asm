...
; 34: pterodon
        monster_steal      MAIN_GAUCHE, MITHRILKNIFE
        monster_drop       POTION, EMPTY
...
; 36: white_drgn
        monster_steal      HOLY_LANCE, X_POTION
        monster_drop       EMPTY, EMPTY
...
; 159: heavyarmor
        monster_steal      IRON_HELMET, TONIC
        monster_drop       EMPTY, EMPTY
...
; 314: merchant
        monster_steal      MAIN_GAUCHE, PLUMED_HAT
        monster_drop       EMPTY, EMPTY
