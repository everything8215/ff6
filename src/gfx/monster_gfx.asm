...
.macro make_monster_gfx_prop gfx, bpp, size, pal
        ...
        gfx_id .set MonsterGfx::gfx >> 3
        .if bpp = 3
                gfx_id .set gfx_id | $8000
        .endif

        .ifnblank pal
                pal_id .set MonsterPal::pal >> 4
        .else
                pal_id .set MonsterPal::gfx >> 4
        .endif

        .if size = 16
                pal_id .set pal_id | $8000
                stencil_id = MONSTER_STENCIL_LARGE::gfx
        .else
                stencil_id = MONSTER_STENCIL_SMALL::gfx
        .endif
...
MonsterPal:
        ...
        inc_monster_pal FIRST_CLASS, "1st_class"
