...
#### `ram_array <label>, <count>, <item_size>, [block_size]`, `end_ram_array`, `end_ram_block`
...
The optional `block_size` parameter causes the array to be created as a set
of sequential blocks, each with size `block_size`. This is a technique sometimes
...
```text
ram_array BlockArray, 16, 32, 16
      ram_res 16, FirstBlock
      end_ram_block
      ram_res 16, SecondBlock
      end_ram_block
end_ram_array
```
