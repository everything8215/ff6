...
.export TfrSong_ext, TfrSongScript_ext  ; unused
...
; [ check alternate start position ]
...
@061f:  php
        ...
        lda     $00
        cmp     #$14
        bcs     @0638       ; branch if new song is loading from alternate start position
        ldx     #0
@062b:  lda     f:AltStartSongTbl,x
        bmi     @063e       ; return if end of list is reached
        cmp     $01
        beq     @0638       ; branch if new song has alternate start position
        inx
        bra     @062b
@0638:  lda     #$04        ; play song from alternate start position
        ora     $00
        sta     $00
@063e:  plp
        rts
...
; pointers to game sound effects that are stored right after. This
...
; songs with alternate start positions (none of these songs have an alternate start position)
AltStartSongTbl:
